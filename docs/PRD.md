...
### 4.1 표기 규칙
- Q/W/E는 **2단계 재사용(recast) 스킬** — 1단계 사용 후 2단계 재사용 가능
- 표기: **Q1/Q2, W1/W2, E1/E2** (항상 숫자 포함, 맨 Q/W/E 단독 사용 금지)
- R은 단일 스킬 (recast 없음)
- Q1→Q2는 하나의 스킬 Q의 2단 사용, 별개 스킬 아님
- 쿨다운은 Q 전체에 하나 (Q2 사용 후 또는 Q1 시간 만료 후 쿨다운 시작)
- 기력도 단계별 소모 (Q1: 50, Q2: 25)
- 챔피언마다 recast 구조 다를 수 있음 — JSON에 정의
