...
- 플레이어의 행동에 대해 **친구처럼 논쟁하고 반응**한다
  - "야 거기서 Q를 왜 써? 미니언한테 막히잖아 ㅋㅋ"
  - "오 ㄷㄷ 그건 잘 피했다"  
  - "W 쉴드 타이밍 봐라, 이렇게 쓰는 거야"
...
\`\`\`json
{
  ...
  "aiChat": "AI가 친구처럼 하는 말 — 논쟁, 감탄, 조언, 놀림 등. 스킬 메커니즘 설명 포함 가능. 반드시 포함!"
}
\`\`\`
...
- aiChat은 반드시 포함 (친구처럼 반응 + 스킬 팁). 예: "야 Q는 미니언 뒤에선 안 맞아ㅋㅋ", "오 W로 미니언 타서 피했네 ㄷㄷ", "E 맞으면 둔화 걸려서 도망 못 가 조심해"
`;
}
